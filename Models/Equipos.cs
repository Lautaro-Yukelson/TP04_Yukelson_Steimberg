...
namespace TP04_Yukelson_Steimberg.Models
{
    ...
    {
        public static List<string> ListaEquipos { get; private set; } = new List<string> { "Equipo1", "Equipo2", "Equipo3", "Equipo4", "Equipo5", "Equipo6", "Equipo7", "Equipo8", "Equipo9", "Equipo10" };
